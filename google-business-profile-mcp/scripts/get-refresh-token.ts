#!/usr/bin/env tsx
/**
 * One-time helper to generate an OAuth2 refresh token for google-business-profile-mcp.
 *
 ...
 *   npm run auth
 *
 * Requires GOOGLE_BUSINESS_PROFILE_CLIENT_ID and GOOGLE_BUSINESS_PROFILE_CLIENT_SECRET to already be set in .env
...
server.listen(PORT, () => {
  ...
  console.log("(Use the Google account that has access to your Google Business Profile.)");
