  ...
  async initialize(): Promise<void> {
    ...
    try {
      ...
      this.agent = new Agent({
        // rejectUnauthorized removido deliberadamente: o valor original (`false`) desativava
        // a verificação do certificado TLS do servidor, abrindo brecha para man-in-the-middle
        // justamente na conexão que carrega o certificado digital do advogado. Não usar `false` aqui.
        cert: cert as any,
        key: key as any,
