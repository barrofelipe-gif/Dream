#!/usr/bin/env tsx
/**
 * One-time helper to generate an OAuth2 refresh token for google-youtube-mcp.
 *
 ...
 *   npm run auth
 *
 * Requires GOOGLE_YOUTUBE_CLIENT_ID and GOOGLE_YOUTUBE_CLIENT_SECRET to already be set in .env
...
const SCOPE = "https://www.googleapis.com/auth/youtube https://www.googleapis.com/auth/yt-analytics.readonly";
...
server.listen(PORT, () => {
  ...
  console.log("(Use the Google account that has access to your YouTube channel.)");
