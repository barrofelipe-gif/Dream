#!/usr/bin/env tsx
/**
 * One-time helper to generate an OAuth2 refresh token for google-sheets-mcp.
 *
 ...
 *   npm run auth
 *
 * Requires GOOGLE_SHEETS_CLIENT_ID and GOOGLE_SHEETS_CLIENT_SECRET to already be set in .env
...
if (!clientId || !clientSecret) {
  console.error(
    "\nMissing GOOGLE_SHEETS_CLIENT_ID / GOOGLE_SHEETS_CLIENT_SECRET.\n" +
...
server.listen(PORT, () => {
  ...
  console.log("(Use the Google account that has access to your Google Sheets.)");
